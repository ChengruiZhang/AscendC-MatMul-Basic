...
1.npu_mem.csv:NPU memory usage data.
...
3.npu_module_mem.csv:Here is no description about this file: npu_module_mem, please check in 'Profiling Instructions'!
4.ts_cpu_top_function.csv:TS CPU top functions.
...
8.op_summary.csv:AI Core, AI CPU, AI Vector and Hccl communication operator data,is used to collect statistics on operator details and time consumptions.
...
9.llc_read_write.csv:L3 cache read/write speed.
	Hit Rate: L3 cache hit rate.
	Throughput: L3 cache throughput (MB/s).
10.hbm.csv:HBM memory read/write speed.
